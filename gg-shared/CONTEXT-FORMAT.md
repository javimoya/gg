...
`CONTEXT.md` lives at `.gg/CONTEXT.md`. It is **only a glossary** of the project's ubiquitous
...
**Single context (most projects):** one `.gg/CONTEXT.md`.

**Multiple contexts:** a `.gg/CONTEXT-MAP.md` lists the contexts, where they live, and how they
relate:
